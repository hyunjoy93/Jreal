	...
	<div class="popBox">
		...
		<div class="conBody cols">
				...
				<tbody>
					...
					<tr>
						<th>건물명<span  style="color: red">*</span ></th>
						<td><input type="text" class="input" value="" id="popBuildingNm"></td>
					</tr>
					<tr>
						<th>소유주(남)</th>
	...
	<div class="popBox">
		...
		<div class="conBody cols">
				...
				<tbody>
					...
					<tr>
						<th>건물명<span  style="color: red">*</span ></th>
						<td><input type="text" class="input" value="" id="buildingNm"></td>
					</tr>
					<tr>
						<th>소유주(남)</th>
...
// 		$("#popChrgEmpNm2").val("");
	...
	$("#btnAddSave").on("click", function(e){
		...
		var param = {
		    ...
		    popBuildingNm     : $("#popBuildingNm").val(),            // 소재지(지번)
	...
	$("#btnSave").on("click", function(e){
		...
		var param = {
		    ...
		    popBuildingNm     : $("#buildingNm").val(),        // 건물명
...
function fnInitGrid(){
	...
	var columnsData = [
			...
			, {header:'건물명', name:'butilding_nm', align:'center'}
...
function fnList(slcPageNo){
	...
	// GRID 리스트 조회
	fnAjax("<c:url value='/api/aset/asetList2'/>", params, function(data) {
...
function fnPopupData(asetId){
	...
	fnAjax("<c:url value='/api/aset/asetInfo'/>", param, function(data) {
	    if (successResCode == data.resCode) {
	        ...
	        $("#buildingNm").val(data.info.building_nm);
